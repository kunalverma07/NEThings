...
public class HomecleaningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.homecleaningId);
    ...
    private void checkDocument() { //
        ...
        db.collection("Cleaning").whereEqualTo("district", location).get() //plumber  //change xml
    ...
    private void EventChangeListener() {
        db.collection("Cleaning").whereEqualTo("district", location)
