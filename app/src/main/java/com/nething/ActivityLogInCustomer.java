...
public class ActivityLogInCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_User.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ActivityLogInCustomer.this,ActivityRegisterCustomer.class));

            }
        });

        //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        customer_login.setOnClickListener(v -> {
            if(validate())
            {
                progressBarSet();
                ...
                if(!login_customer_email.equals(""))
                {
                    mAuth.sendPasswordResetEmail(login_customer_email.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(ActivityLogInCustomer.this,"Password Resend Link send to email.",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else
                ...
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        if(email.equals("admin@admin.com")){
                            startActivity(new Intent(ActivityLogInCustomer.this, Admin.class));
                        } else {
                            startActivity(new Intent(ActivityLogInCustomer.this,HomeActivity.class));
                        }
                        Toast.makeText(ActivityLogInCustomer.this, "Welcome.",
                                Toast.LENGTH_SHORT).show();
                    } else {
                        progressBarUnset();
                        Log.w(TAG, "signInWithEmail:failure", task.getException());
                        Toast.makeText(ActivityLogInCustomer.this, "Authentication failed.",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
