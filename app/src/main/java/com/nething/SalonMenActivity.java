...
public class SalonMenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.salonMenId);
    ...
    private void checkDocument() { //
        ...
        db.collection("SalonMen").whereEqualTo("district", location).get() //plumber  //change xml
    ...
    private void EventChangeListener() {
        db.collection("SalonMen").whereEqualTo("district", location)
